...
$(info   GCC=$(TARGET_GCC_VERSION))
$(info   GCC_KERNEL=$(TARGET_GCC_VERSION_KERNEL))
$(info   NDK_VERSION=$(TARGET_NDK_GCC_VERSION))
$(info   CCACHE_ENABLED=$(USE_CCACHE))
$(info   OPTIMIZATIONS=$(GCC_OPTIMIZATION_DUMPVAR))
$(info ============================================)
endif
